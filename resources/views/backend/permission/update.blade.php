            ...
            <div class="card">
               <div class="card-body">
                  <div class="form-validation">
                     <form class="form-valide" action="{{ route('permissions.update', $permissions->id) }}" method="POST" enctype="multipart/form-data" novalidate="novalidate">
                        @csrf
                        <div class="form-group row is-invalid">
                           <label class="col-lg-4 col-form-label" for="val-suggestions">Tên quyền <span class="text-danger">*</span>
                           </label>
                           <div class="col-lg-6">
                              <input name="display_name" value="{{ $permissions->display_name }}" class="form-control" placeholder="Tên quyền">
                        ...
                        <div class="form-group row is-invalid">
                           ...
                           <div class="col-lg-6">
                              <textarea name="description" value="{{ $permissions->description }}" class="form-control" placeholder="Mô tả"></textarea>
                              <div id="val-username-error" class="invalid-feedback animated fadeInDown" style="display: block;">
