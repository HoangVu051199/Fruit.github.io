                    ...
                    <div class="error-content">
                        <div class="card mb-0">
                            <div class="card-body text-center">
                                ...
                                <h4 class="mt-4"><i class="fa fa-thumbs-down text-danger"></i> Sorry!</h4>
                                <p>Bạn không có quyền truy cập trang này.</p>
                                <form class="mt-5 mb-5">
                                    
                                    <div class="text-center mb-4 mt-4"><a href="{{ route('admin.index') }}" class="btn btn-primary">Quay lại Trang Chủ</a>
                                    </div>
                                </form>
